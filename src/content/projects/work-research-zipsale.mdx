...
<ImageContainerMdx projectId={1} imageId="dashboard-id" captionShow={false} />
...
<ImageContainerMdx projectId={1} imageId="zipsale-landing-id" captionShow={true} />
...
<ImageContainerMdx projectId={1} imageId="qual-questionnaire-id" captionShow={true} />
...
<ImageContainerMdx projectId={1} imageId="relisting-workflows-id" captionShow={true} />
...
<ImageContainerMdx projectId={1} imageId="animated-new-dashboard-view-id" captionShow={true} />

<ImageContainerMdx projectId={1} imageId="animated-multi-marketplaces-boosting-id" captionShow={true} />
...
<ImageContainerMdx projectId={1} imageId="animated-final-design-id" captionShow={true} />
